...
ProgramInitial1=CreateProgramTrafficLights([],BusRedOutRedInGreen,BusRedOutRedInYellow,BusRedOutGreenInRed,BusRedOutYellowInRed)
Program1= CreateProgramBusTrafficLights([],BusGreen,BusYellow,BusRedOutRedInGreen,BusRedOutRedInYellow,BusRedOutGreenInRed,BusRedOutYellowInRed)
programPointer1=len(Program1)-2

ProgramInitial2=CreateProgramTrafficLights([],BusRedOutRedInGreen2,BusRedOutRedInYellow2,BusRedOutGreenInRed2,BusRedOutYellowInRed2)
Program2= CreateProgramBusTrafficLights([],BusGreen2,BusYellow2,BusRedOutRedInGreen2,BusRedOutRedInYellow2,BusRedOutGreenInRed2,BusRedOutYellowInRed2)
programPointer2=len(Program2)-2
...
while step==0 or traci.simulation.getMinExpectedNumber() > 0:
    ...
    result1=ChangeBusTrafficLights("3","0","1214943442",step,check1,Program1,programPointer1,i1,ProgramInitial1)
    check1=result1[0]
    programPointer1=result1[1]
    i1=result1[2]

    result2=ChangeBusTrafficLights("2","1","2479049221",step,check2,Program2,programPointer2,i2,ProgramInitial2)
    check2=result2[0]
